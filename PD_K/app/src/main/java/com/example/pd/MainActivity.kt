...
import com.example.pd.ui.lab.Lab
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        labStart.setOnClickListener {
            val labIntent = Intent(this, Lab::class.java)
        ...
        val appBarConfiguration = AppBarConfiguration(setOf(
                R.id.navigation_home, R.id.navigation_profile, R.id.navigation_scoreboard, R.id.personal_account))
